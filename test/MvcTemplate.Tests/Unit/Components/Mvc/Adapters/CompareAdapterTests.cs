...
namespace MvcTemplate.Components.Mvc
{
    public class CompareAdapterTests
    {
        ...
        public void AddValidation_EqualTo()
        {
            ...
            Assert.Equal(Validation.For("EqualTo", context.ModelMetadata.PropertyName, adapter.Attribute.OtherProperty), attributes["data-val-equalto"]);
        }

        [Fact]
        public void GetErrorMessage_EqualTo()
        {
            String expected = Validation.For("EqualTo", context.ModelMetadata.PropertyName, adapter.Attribute.OtherProperty);
